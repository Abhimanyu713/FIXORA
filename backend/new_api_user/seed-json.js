...
const seedFromJSON = async () => {
  try {
    ...
    console.log(
      `📊 Created ${mentorData.length} mentors and ${menteeData.length} mentees`
    );

    // Generate statistics
    console.log("\n📈 Mentor Statistics:");
    console.log(
      `- PhD holders: ${mentorData.filter((m) => m.education === "phd").length}`
    );
    console.log(
      `- Post-graduation: ${
        mentorData.filter((m) => m.education === "post-graduation").length
      }`
    );
    console.log(
      `- Graduation: ${
        mentorData.filter((m) => m.education === "graduation").length
      }`
    );
