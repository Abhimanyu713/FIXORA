...
const seedData = async () => {
  try {
    ...
    console.log(
      `Created ${mentors.length} mentors and ${mentees.length} mentees`
    );

    // Log some statistics
    console.log("\nMentor Statistics:");
    console.log(
      `- PhD holders: ${mentors.filter((m) => m.education === "phd").length}`
    );
    console.log(
      `- Post-graduation: ${
        mentors.filter((m) => m.education === "post-graduation").length
      }`
    );
    console.log(
      `- Graduation: ${
        mentors.filter((m) => m.education === "graduation").length
      }`
    );
